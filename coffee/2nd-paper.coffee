...
normalWidth = 6
innerWidth = 5
outerWidth = 2*normalWidth + innerWidth #17
...
pixel =
  ...
  <symbol viewBox="0 0 100 100">
    <rect width="100" height="100" fill="#f7f6ba" stroke="#a9a9a9" stroke-width={gridWidth}/>
  </symbol>

hole =
  <symbol viewBox="0 0 100 100">
    <rect width="100" height="100" fill="white" stroke="#a9a9a9"/>
  </symbol>
